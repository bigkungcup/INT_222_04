...
const checkPassword = (password) => {
  ...
  if (newUser.value.password === password) {
    passwordValidate.value = false;
    // console.log(passwordValidate.value);
    return false;
  }
      ...
      <div class="bg-white/50 place-self-center my-24 pb-10 rounded-3xl">
        ...
        <div class="grid grid-cols-4 gap-y-8">
          ...
          <div class="col-span-3">
            <input
              type="text"
              class="bg-white border border-slate-300 rounded-lg h-10 w-4/5 text-3xl placeholder:italic placeholder:text-2xl"
              placeholder=" Enter Your Name"
              v-model.trim="newUser.name"
              @input="showNameSame = false"
            />
            <span class="text-gray-500 text-lg ml-0.5"
              >{{ newUser.name.length }}/100</span
            >
            <div
              v-if="
                newUser.name === '' ||
            ...
            <div v-if="newUser.name.length > 100">
              <p class="text-lg text-red-500 absolute">
            ...
            <p
              v-if="
                showNameSame &&
                newUser.name !== '' &&
                newUser.name.length <= 100
              "
              class="text-lg text-red-500 absolute"
            >
          ...
          <div class="col-span-3">
            <input
              ...
              @input="showEmailSame = false"
            /><span class="text-gray-500 text-lg ml-0.5"
              >{{ newUser.email.length }}/50</span
            >
            ...
            <div
              v-if="
                newUser.email.match(validEmail) === null && newUser.email !== ''
              "
            >
              <p v-show="user.textPopUp" class="text-lg text-red-500 absolute">
                *Invalid Email.
            ...
            <p
              v-if="
                showEmailSame &&
                newUser.email !== '' &&
                newUser.email.match(validEmail) !== null &&
                newUser.email.length <= 50
              "
              class="text-lg text-red-500 absolute top-83"
            >
          ...
          <div class="col-span-3">
            <form>
              ...
              <span class="text-gray-500 text-lg ml-0.5"
                >{{ newUser.password.length }}/14</span
              >
            </form>
            <p
              class="text-gray-400 text-lg absolute"
              v-show="!user.textPopUp && newUser.password === ''"
            >
              Use 8-14 characters for password
            </p>
          ...
          <div class="col-span-3">
            <form>
              ...
              <span class="text-gray-500 text-lg ml-0.5"
                >{{ passwordConfirm.length }}/14</span
              >
            </form>
          ...
          <div
            class="col-span-4 place-self-center space-x-4 text-rose-800 text-2xl mt-2"
          >
            <input
              type="radio"
              id="1"
        ...
        <p v-show="user.textPopUp" class="text-lg text-red-500 ml-10">*Please choose your role.</p>
          ...
          <div class="col-span-4 place-self-center">
            ...
            <!-- <button class="bg-rose-400 text-white rounded-3xl w-36 py-2 mx-2 drop-shadow-xl hover:bg-white hover:text-rose-800" 
                @click="checkPassword(passwordConfirm)"> -->
            <!-- Register -->
            <!-- </button> -->
            <button
