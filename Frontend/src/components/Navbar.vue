  ...
  <div class="fixed w-20 h-screen drop-shadow-md bg-black/25">
    <div class="p-3">
      <router-link :to="{ name: 'Home' }"
        ><img src="../assets/images/Home.png" width="50" class="pb-8 pt-4"
      /></router-link>
      <router-link :to="{ name: 'Schedule' }"
        ><img src="../assets/images/Lists.png" width="50" class="pb-8"
      /></router-link>
      <router-link :to="{ name: 'Booking' }"
        ><svg width="2.5em" height="2.5em" viewBox="0 0 26 26" class="ml-2">
          <path
            fill="#ffffff"
