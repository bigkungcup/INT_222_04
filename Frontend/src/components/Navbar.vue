  ...
  <div class="fixed w-20 h-screen drop-shadow-md bg-black/25">
    <div class="p-3">
      ...
      <router-link :to="{ name: 'Login'}">
        <svg width="50" v-show="!login.logoutIcon" class="mt-48 transition duration-150 ease-in-out hover:scale-125" viewBox="0 0 15 15"><path fill="#ffffff" d="M5 5.5a2.5 2.5 0 1 1 5 0a2.5 2.5 0 0 1-5 0Z"/><path fill="#ffffff" fill-rule="evenodd" d="M7.5 0a7.5 7.5 0 1 0 0 15a7.5 7.5 0 0 0 0-15ZM1 7.5a6.5 6.5 0 1 1 10.988 4.702A3.5 3.5 0 0 0 8.5 9h-2a3.5 3.5 0 0 0-3.488 3.202A6.482 6.482 0 0 1 1 7.5Z" clip-rule="evenodd"/></svg>
        <svg width="50" v-show="login.logoutIcon" class="mt-48 transition duration-150 ease-in-out hover:scale-125" viewBox="0 0 15 15"><path fill="#00ff00" d="M5 5.5a2.5 2.5 0 1 1 5 0a2.5 2.5 0 0 1-5 0Z"/><path fill="#00ff00" fill-rule="evenodd" d="M7.5 0a7.5 7.5 0 1 0 0 15a7.5 7.5 0 0 0 0-15ZM1 7.5a6.5 6.5 0 1 1 10.988 4.702A3.5 3.5 0 0 0 8.5 9h-2a3.5 3.5 0 0 0-3.488 3.202A6.482 6.482 0 0 1 1 7.5Z" clip-rule="evenodd"/></svg>
      </router-link>
